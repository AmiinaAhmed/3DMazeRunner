...
import static StartGame.menu_play.len_wid;
 ...
 * @author hp
 */
public class gameover extends JFrame implements base_form{
    private GameMap gameMap;
     ...
     int num_tries;
     int num_gifts;
    public gameover(int num_tries,int num_g,long num_min,long num_sec)throws IOException{
    ...
    private void create_title(JLabel label1_ground){
       try {
           JLabel maze=new JLabel(new ImageIcon(ImageIO.read(new File("res/textfx.png"))));
           ...
           label1_replay.addMouseListener(new MouseAdapter() {
               ...
               public void mouseClicked(MouseEvent e) {
                   try {
                       ...
                       startLoadLevel();
                       System.err.println(menu_play.width_land);
